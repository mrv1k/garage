...
export type SiteFieldsEnum =
  ...
  | 'siteMetadata___cv___title'
  | 'siteMetadata___cv___description'
  | 'siteMetadata___blog___title'
  | 'siteMetadata___blog___description'
  | 'siteMetadata___garden___title'
...
export type SiteSiteMetadataCv = {
  title: Maybe<Scalars['String']>;
  description: Maybe<Scalars['String']>;
};

export type SiteSiteMetadataCvFilterInput = {
  title: Maybe<StringQueryOperatorInput>;
  description: Maybe<StringQueryOperatorInput>;
};
...
export type SiteSiteMetadataFilterInput = {
  title: Maybe<StringQueryOperatorInput>;
  description: Maybe<StringQueryOperatorInput>;
  cv: Maybe<SiteSiteMetadataCvFilterInput>;
...
export type EmailContactLinkQuery = { site: Maybe<{ siteMetadata: Maybe<{ author: Maybe<{ email: Maybe<string> }> }> }> };

export type SeoQueryVariables = Exact<{ [key: string]: never; }>;


export type SeoQuery = { site: Maybe<{ siteMetadata: Maybe<{ title: Maybe<string>, description: Maybe<string>, author: Maybe<{ name: Maybe<string> }> }> }> };

export type AboutPageQueryVariables = Exact<{ [key: string]: never; }>;


export type AboutPageQuery = { site: Maybe<{ siteMetadata: Maybe<{ social: Maybe<{ github: Maybe<string>, linkedin: Maybe<string> }>, author: Maybe<{ name: Maybe<string> }> }> }> };
...
export type GatsbyImageSharpFixedFragment = { base64: Maybe<string>, width: number, height: number, src: string, srcSet: string };

export type GatsbyImageSharpFixed_TracedSvgFragment = { tracedSVG: Maybe<string>, width: number, height: number, src: string, srcSet: string };

export type GatsbyImageSharpFixed_WithWebpFragment = { base64: Maybe<string>, width: number, height: number, src: string, srcSet: string, srcWebp: Maybe<string>, srcSetWebp: Maybe<string> };

export type GatsbyImageSharpFixed_WithWebp_TracedSvgFragment = { tracedSVG: Maybe<string>, width: number, height: number, src: string, srcSet: string, srcWebp: Maybe<string>, srcSetWebp: Maybe<string> };

export type GatsbyImageSharpFixed_NoBase64Fragment = { width: number, height: number, src: string, srcSet: string };

export type GatsbyImageSharpFixed_WithWebp_NoBase64Fragment = { width: number, height: number, src: string, srcSet: string, srcWebp: Maybe<string>, srcSetWebp: Maybe<string> };

export type GatsbyImageSharpFluidFragment = { base64: Maybe<string>, aspectRatio: number, src: string, srcSet: string, sizes: string };

export type GatsbyImageSharpFluidLimitPresentationSizeFragment = { maxHeight: number, maxWidth: number };

export type GatsbyImageSharpFluid_TracedSvgFragment = { tracedSVG: Maybe<string>, aspectRatio: number, src: string, srcSet: string, sizes: string };

export type GatsbyImageSharpFluid_WithWebpFragment = { base64: Maybe<string>, aspectRatio: number, src: string, srcSet: string, srcWebp: Maybe<string>, srcSetWebp: Maybe<string>, sizes: string };

export type GatsbyImageSharpFluid_WithWebp_TracedSvgFragment = { tracedSVG: Maybe<string>, aspectRatio: number, src: string, srcSet: string, srcWebp: Maybe<string>, srcSetWebp: Maybe<string>, sizes: string };

export type GatsbyImageSharpFluid_NoBase64Fragment = { aspectRatio: number, src: string, srcSet: string, sizes: string };

export type GatsbyImageSharpFluid_WithWebp_NoBase64Fragment = { aspectRatio: number, src: string, srcSet: string, srcWebp: Maybe<string>, srcSetWebp: Maybe<string>, sizes: string };
